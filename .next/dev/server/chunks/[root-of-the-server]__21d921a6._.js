...
// Create transporters
const hotelTransporter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport({
    host: EMAIL_HOST,
    port: EMAIL_PORT,
...
const tourTransporter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport({
...
tourTransporter.verify((error, success)=>{
    if (error) {
...
"[project]/app/api/tour-booking/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$emailService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/emailService.ts [app-route] (ecmascript)");
;
;
async function POST(request) {
    try {
        const body = await request.json();
        const { fullName, email, countryCode, phone, address, pinCode, destination, adults, children, specialInfo, promoCode, membershipNo, checkIn, checkOut, pickupPlace, dropPlace, costPerAdult, costPerChildren, totalNights, estimatedCost, bookingAmount, paymentType } = body;
        ...
        // Send emails
        const emailSent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$emailService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendTourBookingEmail"])({
            fullName,
            email,
            countryCode,
            phone,
        ...
        if (emailSent) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                message: 'Tour booking request submitted successfully. You will receive a confirmation email shortly.'
            }, {
                status: 200
            });
        } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21d921a6._.js.map