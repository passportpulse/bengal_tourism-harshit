...
"[project]/app/api/hotel-booking/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { fullName, email, countryCode, phone, address, pinCode, destination, roomType, noOfRooms, checkIn, checkOut, adults, children, specialInfo, preferredHotel, costPerRoom, totalNights, estimatedCost, bookingAmount, paymentType, promoCode, membershipNo } = body;
        ...
        // Send emails
        const emailSent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$emailService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendHotelBookingEmail"])({
            fullName,
            email,
            countryCode,
            phone,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf22794a._.js.map