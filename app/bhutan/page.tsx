            ...
            <div className="space-y-8 lg:sticky lg:top-24 h-fit">
              ...
              <div className="bg-gradient-to-br from-yellow-500 to-orange-600 text-white rounded-3xl shadow-lg p-8 text-center">
                <h3 className="text-2xl font-bold mb-4">
                  🏔️ Thunder Dragon Special
                </h3>
                <p className="text-sm opacity-90">
                  Get exclusive discounts on monastery tours.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-10">
            ...
            <div className="space-y-8 lg:sticky lg:top-24 h-fit">
              ...
              <div className="bg-gradient-to-br from-green-500 to-teal-600 text-white rounded-3xl shadow-lg p-8 text-center">
                <h3 className="text-2xl font-bold mb-4">
                  🏛️ Valley of Cranes Special
                </h3>
                <p className="text-sm opacity-90">
                  Explore sacred valleys and ancient fortresses.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-10">
            ...
            <div className="space-y-8 lg:sticky lg:top-24 h-fit">
              ...
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-3xl shadow-lg p-8 text-center">
                <h3 className="text-2xl font-bold mb-4">
                  🦅 Crane Valley Experience
                </h3>
                <p className="text-sm opacity-90">
                  Explore crane habitats and sacred valleys.
                  Special wildlife tours available!
                </p>
