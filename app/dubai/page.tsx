  ...
  return (
    <main className="text-gray-800">
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Book Your Dubai Luxury Experience</h2>
            <p className="text-xl text-purple-100 max-w-3xl mx-auto">
              Special tailor-made packages designed for your perfect luxury adventure
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-white text-purple-800 rounded-2xl p-8 max-w-2xl mx-auto">
              <h3 className="text-2xl font-bold mb-4">Ready for Luxury Dubai Experience?</h3>
              ...
              <div className="mt-6 bg-purple-100 p-4 rounded-lg">
                <p className="text-purple-800 font-bold text-center mb-2">
                  🏙️ Experience Luxury Dubai
                </p>
                <p className="text-sm text-purple-700 text-center">
                  World-class attractions, desert adventures, and premium shopping experiences
                </p>
              </div>
            </div>
          </div>
