  ...
  return (
    <main className="text-gray-800">
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Book Your Eco Adventure</h2>
            <p className="text-xl text-green-100 max-w-3xl mx-auto">
              Special tailor-made packages designed for your perfect sustainable tourism experience
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 text-center">
              ...
              <p className="text-green-100">Pleasant weather</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 text-center">
              ...
              <p className="text-green-100">Custom packages</p>
            </div>

            <div className="bg-white/10 backdrop-blur rounded-2xl p-6 text-center">
              <DollarSign className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Starting From</h3>
              <p className="text-3xl font-bold text-yellow-400 mb-2">₹6,500</p>
          ...
          <div className="text-center">
            <div className="bg-white text-green-800 rounded-2xl p-8 max-w-2xl mx-auto">
              <h3 className="text-2xl font-bold mb-4">Ready for Sustainable Journey?</h3>
