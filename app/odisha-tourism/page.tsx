  ...
  return (
    <main className="text-gray-800">
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-amber-600 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Book Your Odisha Journey</h2>
          ...
          <div className="bg-white text-orange-800 rounded-2xl p-8 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold mb-4">Ready to Explore Odisha?</h3>
            <p className="text-gray-700 mb-6">
              Contact us for personalized Odisha tourism packages with flexible duration and custom itineraries
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="bg-amber-600 text-white px-8 py-3 rounded-full font-bold hover:bg-amber-700 transition">
                ...
                Email: odisha@bengaltourism.com
              </button>
            </div>
            ...
            <div className="mt-6 bg-orange-100 p-4 rounded-lg">
              <p className="text-orange-800 font-bold text-center mb-2">
                🏛️ Discover Ancient Heritage
              </p>
              <p className="text-sm text-orange-700 text-center">
                Experience the divine temples, golden beaches, and rich culture of Odisha
              </p>
            </div>
          </div>
        </div>
