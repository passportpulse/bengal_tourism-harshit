      ...
      <section className="relative h-screen overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Dooars jungle with elephants and tea gardens"
        ...
        <div className="relative h-full flex items-center justify-center text-center text-white px-6">
          <div className="max-w-4xl">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-yellow-400 font-semibold tracking-wide">Gateway to the Himalayas</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              Dooars
              <span className="block text-3xl md:text-5xl mt-2 text-green-300">
                Land of Wildlife & Tea Gardens
              </span>
            </h1>

            <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto leading-relaxed">
              Explore the pristine jungles of Jaldapara, Gorumara, Buxa & Chalsa - 
              home to rhinos, elephants and the legendary one-horned rhinoceros
            </p>
