...
import { MapPin, Calendar, Users, Star, Clock, Camera, Sun, Home, DollarSign, Award, Compass, Utensils, Building, Trees, Ship, Sparkles, Train, ShoppingBag, Book, Mountain, Waves, Fish, Bird, Tent, Flame, PartyPopper, Heart, Sprout, Coffee, Leaf, TreePine } from 'lucide-react'
  ...
  return (
    <main className="text-gray-800">
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Book Your Tea Tourism Experience</h2>
            <p className="text-xl text-emerald-100 max-w-3xl mx-auto">
              Begin your journey through the enchanting tea gardens of North Bengal
            </p>
          </div>

          <div className="bg-white text-emerald-800 rounded-2xl p-8 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold mb-4">Ready for Tea Tourism?</h3>
            <p className="text-gray-700 mb-6">
              Contact us for personalized tea tourism packages designed according to your preferences
            </p>
            ...
            <div className="mt-6 bg-emerald-100 p-4 rounded-lg">
              <p className="text-emerald-800 font-bold text-center mb-2">
                🍃 Discover Tea Heritage
              </p>
              <p className="text-sm text-emerald-700 text-center">
                Experience the authentic tea garden lifestyle in the Himalayan foothills
              </p>
            </div>
          </div>
        </div>
